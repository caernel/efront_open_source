...
//pr($defaultPositions);
	...
	if (G_VERSIONTYPE != 'community') { #cpp#ifndef COMMUNITY
		...
		$lessonSettings['tincan']              = array('text' => _TINCAN,                'image' => "32x32/theory.png",    'onClick' => 'activate(this, \'tincan\')',                'title' => _CLICKTOTOGGLE, 'group' => 2, 'class' => isset($currentLesson -> options['tincan']) && $currentLesson -> options['tincan'] ? null : 'inactiveImage');
		} #cpp#endif
	} #cpp#endif
