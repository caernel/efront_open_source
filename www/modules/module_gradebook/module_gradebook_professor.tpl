...
{capture name = 't_gradebook_professor_code'}
	<div class = "headerTools">
		<span>
			...
			<a href="{$T_GRADEBOOK_BASEURL}&add_column=1&popup=1" target="POPUP_FRAME" onclick="eF_js_showDivPopup(event, '{$smarty.const._GRADEBOOK_ADD_COLUMN}', 0)">{$smarty.const._GRADEBOOK_ADD_COLUMN}</a>&nbsp;
		</span>
		<span>
