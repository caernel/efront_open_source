...
function addBlock(list, block) {		
	if (block) {
		var blockObject = blocks.get(block);
		if(blockObject) {
			var li = new Element('li', {id:list+'_'+block}).insert(new Element('div').addClassName('layoutBlock').insert(new Element('div').update(blockObject.substring(0,50))));
