	{capture name = "t_payment_coupons_code"}
			<div class = "headerTools">
				<span>
					...
					<a href = "{$smarty.server.PHP_SELF}?ctg=payments&coupons=1&add=1&popup=1" title = "{$smarty.const._ADDCOUPON}" target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, '{$smarty.const._ADDCOUPON}', 2)">{$smarty.const._ADDCOUPON}</a>
				</span>
			</div>
<!--ajax:couponsTable-->
			<table style = "width:100%" class = "sortedTable" size = "{$T_TABLE_SIZE}" sortBy = "0" id = "couponsTable" useAjax = "1" rowsPerPage = "{$smarty.const.G_DEFAULT_TABLE_SIZE}" url = "{$smarty.server.PHP_SELF}?ctg=payments&">
				...
				<tr class = "{cycle values = "oddRowColor, evenRowColor"}">
					...
					<td class = "centerAlign">
						<a href = "{$smarty.server.PHP_SELF}?ctg=payments&coupons=1&reports={$coupon.id}&popup=1" target = "POPUP_FRAME"><img class = "handle" src = "images/16x16/reports.png" title = "{$smarty.const._reports}" alt = "{$smarty.const._REPORTS}" onclick = "eF_js_showDivPopup(event, '{$smarty.const._REPORTS}', 2)"/></a>
						<a href = "{$smarty.server.PHP_SELF}?ctg=payments&coupons=1&edit={$coupon.id}&popup=1" target = "POPUP_FRAME"><img class = "handle" src = "images/16x16/edit.png" title = "{$smarty.const._EDIT}" alt = "{$smarty.const._EDIT}" onclick = "eF_js_showDivPopup(event, '{$smarty.const._EDIT}', 2)"/></a>
		...
		{capture name = 't_add_code'}
			...
			<form {$T_ENTITY_FORM.attributes}>
				...
				<table class = "formElements">
					...
					<tr><td class = "labelCell">{$T_ENTITY_FORM.txn_id.label}:&nbsp;</td>
						<td class = "elementCell">{$T_ENTITY_FORM.txn_id.html}</td></tr>
					<tr><td></td>
						<td><span>
	...
	{capture name = "t_payments_history_code"}
			<div class = "headerTools">
				<span>
					...
					<a href = "{$smarty.server.PHP_SELF}?ctg=payments&add=1&popup=1" title = "{$smarty.const._ADDMANUALPAYMENT}" target = "POPUP_FRAME" onclick = "eF_js_showDivPopup(event, '{$smarty.const._ADDMANUALPAYMENT}', 2)">{$smarty.const._ADDMANUALPAYMENT}</a>
				</span>
...
<!--ajax:paymentsTable-->
			<table style = "width:100%" class = "sortedTable" size = "{$T_TABLE_SIZE}" sortBy = "0" id = "paymentsTable" useAjax = "1" rowsPerPage = "{$smarty.const.G_DEFAULT_TABLE_SIZE}" url = "{$smarty.server.PHP_SELF}?ctg=payments&">
				<tr class = "topTitle defaultRowHeight">
					...
					<td class = "topTitle" name = "txn_id">{$smarty.const._TRANSACTIONID}</td>
				...
				<tr class = "{cycle values = "oddRowColor, evenRowColor"}">
					...
					<td class = "centerAlign">
						...
						<img class = "handle" src = "images/16x16/information.png" title = "{$smarty.const._DETAILS}" alt = "{$smarty.const._DETAILS}" onclick = "eF_js_showDivPopup(event, '{$smarty.const._DETAILS}', 1, 'details_div_{$payment.id}')"/>
