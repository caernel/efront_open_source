...
{capture name = "moduleCleanup"}
	    ...
	    <table>
	        <tr><td class = "labelCell">{$smarty.const._ORPHANUSERFOLDERSCHECK}:&nbsp;</td>
	            ...
	            {if $T_ORPHAN_USER_FOLDERS}
	                ...
	                <img src = "images/16x16/help.png"   title = "{$smarty.const._INFO}"    alt = "{$smarty.const._INFO}"    onclick = "eF_js_showDivPopup(event, '{$smarty.const._ORPHANUSERFOLDERSCHECK}', 0, 'orphan_user_folders')"/>&nbsp;
	        ...
	        <tr><td class = "labelCell">{$smarty.const._USERSWITHOUTFOLDERSCHECK}:&nbsp;</td>
	            ...
	            {if $T_ORPHAN_USERS}
	                <img src = "images/16x16/warning.png"    title = "{$smarty.const._PROBLEM}"      alt = "{$smarty.const._PROBLEM}"/>&nbsp;
	                <img src = "images/16x16/help.png"      title = "{$smarty.const._INFO}"         alt = "{$smarty.const._INFO}"         onclick = "eF_js_showDivPopup(event, '{$smarty.const._USERSWITHOUTFOLDERSCHECK}', 0, 'users_without_folders')"/>&nbsp;
	        ...
	        <tr><td class = "labelCell">{$smarty.const._ORPHANLESSONFOLDERSCHECK}:&nbsp;</td>
	            ...
	            {if $T_ORPHAN_LESSON_FOLDERS}
	                <img src = "images/16x16/warning.png" title = "{$smarty.const._PROBLEM}" alt = "{$smarty.const._PROBLEM}"/>&nbsp;
	                <img src = "images/16x16/help.png"   title = "{$smarty.const._INFO}"    alt = "{$smarty.const._INFO}"    onclick = "eF_js_showDivPopup(event, '{$smarty.const._ORPHANLESSONFOLDERSCHECK}', 0, 'orphan_lesson_folders')"/>&nbsp;
	        ...
	        <tr><td class = "labelCell">{$smarty.const._LESSONSWITHOUTFOLDERSCHECK}:&nbsp;</td>
	            ...
	            {if $T_ORPHAN_LESSONS}
	                <img src = "images/16x16/warning.png"    title = "{$smarty.const._PROBLEM}"      alt = "{$smarty.const._PROBLEM}"/>&nbsp;
	                <img src = "images/16x16/help.png"      title = "{$smarty.const._INFO}"         alt = "{$smarty.const._INFO}"         onclick = "eF_js_showDivPopup(event, '{$smarty.const._LESSONSWITHOUTFOLDERSCHECK}', 0, 'lessons_without_folders')"/>&nbsp;
    ...
    {capture name = 't_reindex_code'}
        <table>
		    ...
		    <tr><td class = "labelCell">{$smarty.const._CLICKHERETOREDELETEADVANCEDREPORTVIEWS}:&nbsp;</td>
