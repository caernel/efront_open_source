		...
		{if $smarty.get.topic}
	        {capture name = 't_topic_code'}
                ...
                <div class = "headerTools">
                    ...
                    {else}
                		<a href = "{$smarty.server.PHP_SELF}?ctg=forum&add=1&type=message&topic_id={$smarty.get.topic}&popup=1" onclick = "eF_js_showDivPopup(event, '{$smarty.const._NEWMESSAGE}', 1)" target = "POPUP_FRAME" >{$smarty.const._NEWMESSAGE}</a>
                    {/if}
					</span>
				</div>
                {/if}
		...
		{capture name = 't_forums_code'}
			...
			{if $_change_}
	            ...
	            {if $smarty.get.forum}
	                ...
	                {else}
						<img src = "images/16x16/add.png" alt = "{$smarty.const._NEWTOPIC}" title = "{$smarty.const._NEWTOPIC}"/>
						<a href = "{$smarty.server.PHP_SELF}?ctg=forum&add=1&type=topic&forum_id={$T_PARENT_FORUM}&popup=1" onclick = "eF_js_showDivPopup(event, '{$smarty.const._NEWTOPIC}', 2)" target = "POPUP_FRAME">{$smarty.const._NEWTOPIC}</a>
					{/if}
					</span>
					...
					<span>
						...
						{else}
						<img src = "images/16x16/add.png" alt = "{$smarty.const._NEWPOLL}" title = "{$smarty.const._NEWPOLL}"/>
        				<a href = "{$smarty.server.PHP_SELF}?ctg=forum&add=1&type=poll&forum_id={$T_PARENT_FORUM}&popup=1" onclick = "eF_js_showDivPopup(event, '{$smarty.const._NEWPOLL}', 3)" target = "POPUP_FRAME">{$smarty.const._NEWPOLL}</a>
						{/if}
					</span>
					{/if}
	            {/if}
          	{if $smarty.session.s_type == 'administrator'}
                    <span>
                        ...
                        <a href = "{$smarty.server.PHP_SELF}?ctg=forum&config=1&popup=1" onclick = "eF_js_showDivPopup(event, '{$smarty.const._FORUMCONFIGURATIONPANEL}', 1)" target = "POPUP_FRAME">{$smarty.const._FORUMCONFIGURATIONPANEL}</a>
                    </span>
           	{/if}
                ...
                <img src = "images/16x16/unlocked.png" alt = "{$smarty.const._PUBLIC}" title = "{$smarty.const._PUBLIC}"/><span style = "display:none">{$smarty.const._PUBLIC}</span>
						...
						{if ($_change_) && !$_student_}
	                        ...
	                        {if $_admin_ || ($_professor_ && $smarty.session.s_login == $subforum.users_LOGIN)}
						                        	<a href = "{$smarty.server.PHP_SELF}?ctg=forum&edit={$subforum.id}&type=forum&parent_forum_id={$T_PARENT_FORUM}&popup=1" onclick = "eF_js_showDivPopup(event, '{$smarty.const._EDIT}', 1)" target = "POPUP_FRAME"><img class = "handle" src = "images/16x16/edit.png" title = "{$smarty.const._EDIT}" alt = "{$smarty.const._EDIT}" /></a>
	                ...
	                {if $T_FORUM_POLLS}
						...
						{if $_change_}
	                        ...
	                        {if $smarty.session.s_type == 'administrator' || $smarty.session.s_login == $poll.users_LOGIN}
									                <a href = "{$smarty.server.PHP_SELF}?ctg=forum&type=poll&edit={$poll.id}&popup=1"   onclick = "eF_js_showDivPopup(event, '{$smarty.const._EDIT}', 2)" class = "editLink"   target = "POPUP_FRAME"><img class = "handle" src = "images/16x16/edit.png"   title = "{$smarty.const._EDIT}"   alt = "{$smarty.const._EDIT}" /></a>
...
<!--ajax:topicsTable-->	                                    
	                                   ...
	                                   <table style = "width:100%" class = "sortedTable" size = "{$T_TABLE_SIZE}" sortBy = "2" order="asc" id = "topicsTable" useAjax = "1" rowsPerPage = "{$smarty.const.G_DEFAULT_TABLE_SIZE}" url = "{$smarty.server.PHP_SELF}?ctg=forum&forum={$smarty.get.forum}&">
                ...
                <a href = "{$smarty.server.PHP_SELF}?ctg=forum&type=topic&edit={$topic.id}&popup=1"   onclick = "eF_js_showDivPopup(event, '{$smarty.const._EDIT}', 1)" class = "editLink"   target = "POPUP_FRAME"><img class = "handle" src = "images/16x16/edit.png"   title = "{$smarty.const._EDIT}"   alt = "{$smarty.const._EDIT}"   /></a>
...
<!--/ajax:topicsTable-->	                           
	            ...
	            {else}
<!--ajax:forumsTable-->	            
	                <table style = "width:100%" class = "sortedTable" size = "{$T_TABLE_SIZE}" sortBy = "2" order="desc" id = "forumsTable" useAjax = "1" rowsPerPage = "{$smarty.const.G_DEFAULT_TABLE_SIZE}" url = "{$smarty.server.PHP_SELF}?ctg=forum&">
	                    <tr>
